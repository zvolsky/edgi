...
'dodávaná délka [cm]': 'dodávaná délka [cm]',
'dodávaná šířka [cm]': 'dodávaná šířka [cm]',
...
'not in': 'not in',
'název prvku': 'název prvku',
'Object or table name': 'Objekt či tabulka',
'odpad/prořez [%]': 'odpad/prořez [%]',
...
'Views': 'Pohledy',
'views': 'pohledy',
'výr.cena jednotková': 'výr.cena jednotková',
'výrobce': 'výrobce',
'výrobní cena': 'výrobní cena',
